...
function NewProducts() {
    ...
    useEffect(() => {
        ...
        fetch('http://localhost:5001/api/products')
            ...
            .then(data => {
                const newProductIds = [1, 2, 5, 9, 13, 4, 15, 6, 17, 18, 20];
                const filteredNewProducts = data.filter(item => newProductIds.includes(item.id));
        ...
        <Box sx={{ textAlign: "center", mt: 8, mb: 12, position: "relative" }}>
            <Box sx={{ mb: 6 }}>
                ...
                <Typography variant="body1" sx={{ color: "#888", fontStyle: "italic" }}>
                    Explore the latest trends directly from the runway.
                </Typography>
            </Box>
                            ...
                            >
                                <Chip
                                    ...
                                    sx={{
                                        ...
                                        bgcolor: "#222", color: "#fff", fontWeight: 700,
