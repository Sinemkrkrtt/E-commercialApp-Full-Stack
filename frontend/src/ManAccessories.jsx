...
function ManAccessories() {
    ...
    useEffect(() => {
        ...
        fetch('http://localhost:5001/api/products')
            ...
            .then(data => {
                const accessoriesIds = [35, 276, 277, 278, 279, 280, 281, 282, 283, 284, 285, 286, 287, 288, 289, 290, 291, 292, 293, 294];
                const filteredAccessories = data.filter(item => accessoriesIds.includes(item.id));
