...
function ManShoes() {
    ...
    useEffect(() => {
        ...
        fetch('http://localhost:5001/api/products')
            ...
            .then(data => {
                const shoeIDs = [5, 257, 258, 259, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275];
                const filteredShoe = data.filter(item => shoeIDs.includes(item.id));
                setProducts(filteredShoe);
            })
